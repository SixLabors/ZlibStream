...
namespace SixLabors.ZlibStream
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZStreamException"/> class with no argrument.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZStreamException" /> class with
        ...
        public ZStreamException(string message, int hresult)
        ...
        private ZStreamException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
#endif
